...
<body>
  ...
  <div class="container-fluid px-5 mt-3">
    ...
    <div class=" bg-light ">
            <h3 class="thin text-center">Statistiques des Moyennes Générales : ~ {{$nsess}} ~ ( {{$c}}  {{$s}}  {{$g}} )</h3>
            </div>
            <hr>
  </div>
...
<div class="col-md-2 ">
  <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
    ...
    <button  class="btn btn-success btn-lg" id="v-pills-messages-tab" data-bs-toggle="pill" data-bs-target="#v-pills-messages" type="button" role="tab" aria-controls="v-pills-messages" aria-selected="false">Trimestre 3</button><br>
    <button class="btn btn-success btn-lg" id="v-pills-settings-tab" data-bs-toggle="pill" data-bs-target="#v-pills-settings" type="button" role="tab" aria-controls="v-pills-settings" aria-selected="false">Annuelle</button>
  </div>
</div>
<div class="col-md-10 bg-white">
  <div class="tab-content" id="v-pills-tabContent" style="padding-left:3%;">
    ...
    <div class="tab-pane fade" id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-settings-tab"><div id="annu"></div></div>
</div>
</div>
</div> --}}
...
<div class="row" id="contenutrim3">
  ...
  <div class="row" id="contenuannuelle">
      <div class="col-md-6">
        <div class="mt-4">
        <div>
          <p class="text-center bg-success text-white">BILAN STATISTIQUE</p>
           <table border=1px class="table table-danger table-striped " id="tbl4" width=100%>
            <thead>
              <th class="text-center">Moyenne </th>
              <th class="text-center">Effectif </th>
            </thead>
        ...
        <div>
        <p class="text-center bg-success mt-5 text-white">MOYENNE</p>
           <table border=1px class="table table-warning table-striped bg-info" id="tbll4" width=100%>
            <thead>
              <th class="text-center">Type </th>
              <th class="text-center">Moyenne </th>
            </thead>
            <tbody id="tbodyy4"></tbody>
           </table>
        </div>
        </div>
      </div>
