				...
				<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
					<div class="panel panel-default">
						<div class="panel-body">
							<h3 class="thin text-center">Valider l'Année Scolaire en Cours : ~ {{$rqan[0]->annee}} ~ </h3>
						<hr>

							<form method="" action="{{url('van_save')}}">
										...
										<table width="100%" class="table table-secondary table-striped bg-info" id="tbl">
											<thead class="thead-dark">
												<tr class="bg-primary" >
													...
													@foreach ($rqs as $s)
														<th class="text-center" width="15%">{{$s->nom_session}}</th>
													@endforeach
